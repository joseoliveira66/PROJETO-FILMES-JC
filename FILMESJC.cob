       ...
       PROGRAM-ID. FILMESJC.
      *****************************************
      *OBJECT: PROGRAMA GESTAO DE CATALOGO DE FILMES
      *AUTHOR: JOSE CARLOS DE OLIVEIRA
      *CLIENT: CODIGO DE BASE / EDUC360
      *****************************************
      ...
      * -----VARIAVEIS DE TRABALHO DO PROGRAMA-----------
       ...
       77 WRK-CONTINUA-MODULO       PIC X(02)   VALUE 'S'.
      ...
      * -DEFINICAO DAS TELAS DE INTERACAO COM O USUARIO--
       ...
       01 MENU.
           ...
           05 LINE 14 COLUMN 60 USING WRK-OPCAO.
      ...
      * -----ROTINA PARA CADASTRAR UM NOVO FILME--------------
       5000-CADASTRO.
           ...
           MOVE 'DIGITE O CODIGO E TECLE ENTER E TAB PARA NAVEGAR'
                 TO WRK-SEQUENCIA.
           MOVE 'S' TO WRK-CONTINUA-MODULO.
           PERFORM UNTIL WRK-CONTINUA-MODULO NOT = 'S' AND
                         WRK-CONTINUA-MODULO NOT = 's'
             MOVE SPACES TO TITULO GENERO DISTRIBUIDORA WRK-MSGERRO
           ...
           ACCEPT WRK-CONTINUA-MODULO AT LINE 22 COLUMN 40
           END-PERFORM.
      ...
      * -----ROTINA PARA CONSULTAR UM FILME----------------------
       6000-CONSULTA.
           ...
           ACCEPT CHAVE
               READ FILMES
                    INVALID KEY
                        MOVE 'FILME NAO ENCONTRADO.TECLE ENTER'
                            TO WRK-MSGERRO
                    NOT INVALID KEY
                        MOVE 'FILME ENCONTRADO. TECLE ENTER'
                            TO WRK-MSGERRO
                        DISPLAY SS-DADOS
               END-READ
               PERFORM 9999-MOSTRAR-ERRO
               DISPLAY 'DESEJA FAZER OUTRA CONSULTA? (S/N)'
                        AT LINE 22 COLUMN 10
                ACCEPT WRK-CONTINUA-MODULO AT LINE 22 COLUMN 45
           END-PERFORM.

      * -----ROTINA PARA ALTERAR UM FILME----------------------
       7000-ALTERACAO.
           ...
           ACCEPT CHAVE LINE 05 COL 32
               READ FILMES
                INVALID KEY
                    ...
                    PERFORM 9999-MOSTRAR-ERRO
                NOT INVALID KEY
                   MOVE 'FILME ENCONTRADO. TECLE ENTER PARA NOVOS DADOS'
                         TO WRK-MSGERRO
                   PERFORM 9999-MOSTRAR-ERRO
                    ...
                    DISPLAY 'TITULO ATUAL.......: '   LINE 7  COL 10
                    DISPLAY WRK-TITULO                LINE 7  COL 30
                    DISPLAY 'NOVO TITULO........: '   LINE 8  COL 10
                    ACCEPT  WRK-TITULO                LINE 8  COL 30

                    DISPLAY 'GENERO ATUAL.......: '   LINE 9  COL 10
                    DISPLAY WRK-GENERO                LINE 9  COL 30
                    DISPLAY 'NOVO GENERO........: '   LINE 10 COL 10
                    ACCEPT WRK-GENERO                 LINE 10 COL 30

                    DISPLAY 'DURACAO ATUAL......: '   LINE 11 COL 10
                    DISPLAY WRK-DURACAO               LINE 11 COL 30
                    DISPLAY 'NOVA DURACAO.......: '   LINE 12 COL 10
                    ACCEPT WRK-DURACAO                LINE 12 COL 30

                    DISPLAY 'DISTRIBUIDORA ATUAL: '   LINE 13 COL 10
                    DISPLAY WRK-DISTRIBUIDORA         LINE 13 COL 30
                    DISPLAY 'NOVA DISTRIBUIDORA.: '   LINE 14 COL 10
                    ACCEPT WRK-DISTRIBUIDORA          LINE 14 COL 30

                    DISPLAY 'NOTA ATUAL.........: '   LINE 15 COL 10
                    DISPLAY WRK-NOTA                  LINE 15 COL 30
                    DISPLAY 'NOVA NOTA..........: '   LINE 16 COL 10
                    ACCEPT WRK-NOTA                   LINE 16 COL 30
               ...
               DISPLAY 'DESEJA ALTERAR OUTRO FILME? (S/N): '
                        AT LINE 22 COLUMN 10
               ACCEPT WRK-CONTINUA-MODULO AT LINE 22 COLUMN 46
           END-PERFORM.
           ...
           ACCEPT CHAVE LINE 05 COL 40
               ...
               READ FILMES
                ...
                NOT INVALID KEY
                    ...
                    ACCEPT WRK-TECLA LINE 20 COLUMN 35
                    IF WRK-TECLA = 'S' OR WRK-TECLA = 's'
                        DELETE FILMES
                            INVALID KEY
                               MOVE 'ERRO AO EXCLUIR FILME. TECLE ENTER'
                                      TO WRK-MSGERRO
                            NOT INVALID KEY
                               MOVE 'FILME EXCLUIDO. TECLE ENTER'
                                     TO WRK-MSGERRO
                        END-DELETE
                        PERFORM 9999-MOSTRAR-ERRO
                    ELSE
                        MOVE 'FILME NAO EXCLUIDO. TECLE ENTER'
                            TO WRK-MSGERRO
                        PERFORM 9999-MOSTRAR-ERRO
                    END-IF
               END-READ
